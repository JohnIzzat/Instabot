...
def main():
    ...
    while True:
        try:
            ...
            print("Não encontrei a postagem")

    # Esperando a pagina carregar
    sleep(10)

    # Definindo o tempo e a mensagem
    tempo_intervalo = 320  # Intervalo de tempo em segundos
    mensagem = "Eu posso eu consigo"
